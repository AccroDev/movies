...
<template>
  <section @click="emits('closeAddModal')" class="fixed top-0 left-0 bottom-0 right-0 bg-black/80 w-full h-full z-30 flex justify-center items-center">
    <div @click.stop class="bg-white rounded-md w-[95%] sm:w-4/5 max-w-2xl h-[90%] overflow-hidden flex justify-center items-center p-2 sm:p-4 addShopWrapper relative">
      <div class="w-full max-h-full overflow-y-auto overflow-x-hidden">
        <h2 class="text-2xl font-bold mb-6 mt-8 sm:mt-4 text-center text-back">Modifier Dans Mes Boutiques</h2>
